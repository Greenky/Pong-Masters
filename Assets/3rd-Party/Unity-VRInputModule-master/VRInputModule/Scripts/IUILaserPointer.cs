...
namespace Wacki {
    abstract public class IUILaserPointer : MonoBehaviour {
        ...
        protected virtual void Update()
        {
			...
			if (pointer != null && hitInfo.collider)
			{
				if (hitInfo.collider.name == "Panel" || hitInfo.collider.name == "MenuPanelGame" || hitInfo.collider.name == "Exit.Button" || hitInfo.collider.name == "Restart.Button")
